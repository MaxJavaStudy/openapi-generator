...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_EnhancedCoverageRestrictionDataRetrievalApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_EnhancedCoverageRestrictionDataRetrievalApi_H_
...
public:
    ...
    explicit EnhancedCoverageRestrictionDataRetrievalApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<std::shared_ptr<EnhancedCoverageRestrictionData>> getEcrData(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_EnhancedCoverageRestrictionDataRetrievalApi_H_ */
