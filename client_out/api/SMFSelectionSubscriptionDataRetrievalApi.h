...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_SMFSelectionSubscriptionDataRetrievalApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_SMFSelectionSubscriptionDataRetrievalApi_H_
...
public:
    ...
    explicit SMFSelectionSubscriptionDataRetrievalApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<std::shared_ptr<SmfSelectionSubscriptionData>> getSmfSelData(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_SMFSelectionSubscriptionDataRetrievalApi_H_ */
