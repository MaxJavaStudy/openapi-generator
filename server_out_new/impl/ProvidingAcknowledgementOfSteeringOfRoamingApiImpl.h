...
class ProvidingAcknowledgementOfSteeringOfRoamingApiImpl : public org::openapitools::server::api::ProvidingAcknowledgementOfSteeringOfRoamingApi {
public:
    ProvidingAcknowledgementOfSteeringOfRoamingApiImpl(){};
    ~ProvidingAcknowledgementOfSteeringOfRoamingApiImpl() {}

    static void sor_ack_info(const std::string &supi, const AcknowledgeInfo &acknowledgeInfo, response &responseIn)
    {
        // not implement
    }
