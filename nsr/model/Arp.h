...
public:
  explicit Arp() {
    ...
    *m_PriorityLevelOutFlag.get() = 0;
    ...
    m_PreemptCapOutFlag.reset(new unsigned);
    *m_PreemptCapOutFlag.get() = 0;

    m_PreemptVulnFlag = staticjson::Flags::Default;
    m_PreemptVulnOutFlag.reset(new unsigned);
    *m_PreemptVulnOutFlag.get() = 0;
  };
  virtual ~Arp(){};
  ...
  void staticjson_init(staticjson::ObjectHandler *h) {
    ...
    h->add_property("priorityLevel", &this->m_PriorityLevel,
                    m_PriorityLevelFlag);
  ...
  PreemptionCapability getPreemptCap() const { return m_PreemptCap; }
  void setPreemptCap(PreemptionCapability const &value) {
    m_PreemptCap = value;
  }

  PreemptionVulnerability getPreemptVuln() const { return m_PreemptVuln; }
...
public:
  ...
  shared_ptr<unsigned> m_PreemptCapOutFlag;
  PreemptionVulnerability m_PreemptVuln;

  unsigned m_PreemptVulnFlag;
  shared_ptr<unsigned> m_PreemptVulnOutFlag;
};
} // namespace model
} // namespace server
} // namespace openapitools
