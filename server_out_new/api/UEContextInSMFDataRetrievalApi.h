...
private:
    ...
    static void get_ue_ctx_in_smf_data_handler(request &requestIn,  response responseIn)
    {
    ...
    /// <param name="supportedFeatures">Supported Features (optional, default to &quot;&quot;)</param>
      UEContextInSMFDataRetrievalApiImpl::get_ue_ctx_in_smf_data(supi, supportedFeatures, response);
