...
private:
    ...
    static void get_sms_mngt_data_handler(request &requestIn,  response responseIn)
    {
    ...
    /// <param name="ifModifiedSince">Validator for conditional requests, as described in RFC 7232, 3.3 (optional, default to &quot;&quot;)</param>
      SMSManagementSubscriptionDataRetrievalApiImpl::get_sms_mngt_data(supi, supportedFeatures, plmnId, ifNoneMatch, ifModifiedSince, response);
