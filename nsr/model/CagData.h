...
public:
  explicit CagData() {
    ...
    m_CagInfosOutFlag.reset(new unsigned);
    *m_CagInfosOutFlag.get() = 0;
    m_ProvisioningTime = "";
  ...
  void staticjson_init(staticjson::ObjectHandler *h) {
    ...
    h->add_optional_property("provisioningTime", &this->m_ProvisioningTime,
                             m_ProvisioningTimeFlag, m_ProvisioningTimeOutFlag);
  ...
  friend std::ostream &operator<<(std::ostream &o, const CagData &obj) {
    ...
    o << "ProvisioningTime, optional flag is : " << *m_ProvisioningTimeOutFlag
      << ", content is : " << obj.m_ProvisioningTime << std::endl;
  ...
  std::map<std::string, CagInfo> &getCagInfos() { return m_CagInfos; }
...
public:
  ...
  shared_ptr<unsigned> m_CagInfosOutFlag;
