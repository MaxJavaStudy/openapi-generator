...
public:
  explicit SmsfInfo() {
    ...
    m_SmsfInstanceIdOutFlag.reset(new unsigned);
    *m_SmsfInstanceIdOutFlag.get() = 0;
  ...
  void staticjson_init(staticjson::ObjectHandler *h) {
    ...
    h->add_property("smsfInstanceId", &this->m_SmsfInstanceId,
                    m_SmsfInstanceIdFlag);
  ...
  std::string getSmsfInstanceId() const { return m_SmsfInstanceId; }
  void setSmsfInstanceId(std::string const &value) { m_SmsfInstanceId = value; }
...
public:
  ...
  shared_ptr<unsigned> m_SmsfInstanceIdOutFlag;
  PlmnId m_PlmnId;
