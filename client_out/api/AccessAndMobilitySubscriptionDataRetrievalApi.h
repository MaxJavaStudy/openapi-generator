...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_AccessAndMobilitySubscriptionDataRetrievalApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_AccessAndMobilitySubscriptionDataRetrievalApi_H_
...
public:
    ...
    explicit AccessAndMobilitySubscriptionDataRetrievalApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<std::shared_ptr<AccessAndMobilitySubscriptionData>> getAmData(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_AccessAndMobilitySubscriptionDataRetrievalApi_H_ */
