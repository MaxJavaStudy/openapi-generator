...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_LCSMobileOriginatedDataRetrievalApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_LCSMobileOriginatedDataRetrievalApi_H_
...
public:
    ...
    explicit LCSMobileOriginatedDataRetrievalApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<std::shared_ptr<LcsMoData>> getLcsMoData(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_LCSMobileOriginatedDataRetrievalApi_H_ */
