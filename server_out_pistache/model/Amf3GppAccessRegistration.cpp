...
std::string Amf3GppAccessRegistration::getAmfServiceNameDereg() const
{
    return m_AmfServiceNameDereg;
}
void Amf3GppAccessRegistration::setAmfServiceNameDereg(std::string const& value)
{
...
std::string Amf3GppAccessRegistration::getAmfServiceNamePcscfRest() const
{
    return m_AmfServiceNamePcscfRest;
}
void Amf3GppAccessRegistration::setAmfServiceNamePcscfRest(std::string const& value)
{
...
void Amf3GppAccessRegistration::setBackupAmfInfo(std::vector<BackupAmfInfo> const& value)
{
...
void Amf3GppAccessRegistration::setEpsInterworkingInfo(EpsInterworkingInfo const& value)
{
