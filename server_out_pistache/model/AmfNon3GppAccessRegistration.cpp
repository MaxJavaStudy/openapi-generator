...
std::string AmfNon3GppAccessRegistration::getAmfServiceNameDereg() const
{
    return m_AmfServiceNameDereg;
}
void AmfNon3GppAccessRegistration::setAmfServiceNameDereg(std::string const& value)
{
...
std::string AmfNon3GppAccessRegistration::getAmfServiceNamePcscfRest() const
{
    return m_AmfServiceNamePcscfRest;
}
void AmfNon3GppAccessRegistration::setAmfServiceNamePcscfRest(std::string const& value)
{
...
void AmfNon3GppAccessRegistration::setBackupAmfInfo(std::vector<BackupAmfInfo> const& value)
{
