...
///
/// </summary>
class Ecgi : public jsonParser::jsonParser<Ecgi> {
public:
  explicit Ecgi() {
    // constructor
    ...
    *m_PlmnIdOutFlag.get() = 0;
    ...
    m_EutraCellIdFlag = staticjson::Flags::Default;
    m_EutraCellIdOutFlag.reset(new unsigned);
    *m_EutraCellIdOutFlag.get() = 0;
    m_Nid = "";
  ...
  void staticjson_init(staticjson::ObjectHandler *h) {
    ...
    // static json settings members vars : PlmnId EutraCellId Nid
    h->add_property("plmnId", &this->m_PlmnId, m_PlmnIdFlag);
    h->add_property("eutraCellId", &this->m_EutraCellId, m_EutraCellIdFlag);
  ...
  friend std::ostream &operator<<(std::ostream &o, const Ecgi &obj) {

    o << "PlmnId : " << obj.m_PlmnId << std::endl;

    o << "EutraCellId : " << obj.m_EutraCellId << std::endl;
  ...
  /////////////////////////////////////////////
  /// Ecgi members vars : PlmnId EutraCellId Nid

  PlmnId getPlmnId() const { return m_PlmnId; }
  void setPlmnId(PlmnId const &value) { m_PlmnId = value; }

  std::string getEutraCellId() const { return m_EutraCellId; }
  void setEutraCellId(std::string const &value) { m_EutraCellId = value; }
...
public:
  ...
  unsigned m_EutraCellIdFlag;
  shared_ptr<unsigned> m_EutraCellIdOutFlag;
  std::string m_Nid;
