...
///
/// </summary>
class PduSessionType : public jsonParser::jsonParser<PduSessionType> {
public:
  explicit PduSessionType(){
      // constructor
  ...
  friend std::ostream &operator<<(std::ostream &o, const PduSessionType &obj) {

    return o;
  }

public:
  std::string m_PduSessionType;
};
