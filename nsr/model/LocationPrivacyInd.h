...
///
/// </summary>
class LocationPrivacyInd : public jsonParser::jsonParser<LocationPrivacyInd> {
public:
  explicit LocationPrivacyInd(){
      // constructor
  ...
  std::pair<jsonRet, std::string> decode(const std::string &jsonBuffer,
    ...
    m_LocationPrivacyInd = jsonBuffer;
    return ret;
  }
  ...
  friend std::ostream &operator<<(std::ostream &o,
                                  const LocationPrivacyInd &obj) {

    return o;
  }

public:
  std::string m_LocationPrivacyInd;
};
