...
private:
    ...
    static void get_nssai_handler(request &requestIn,  response responseIn)
    {
    ...
    /// <param name="ifModifiedSince">Validator for conditional requests, as described in RFC 7232, 3.3 (optional, default to &quot;&quot;)</param>
      SliceSelectionSubscriptionDataRetrievalApiImpl::get_nssai(supi, supportedFeatures, plmnId, ifNoneMatch, ifModifiedSince, response);
