...
class ProvidingAcknowledgementOfCAGUpdateApiImpl : public org::openapitools::server::api::ProvidingAcknowledgementOfCAGUpdateApi {
public:
    ProvidingAcknowledgementOfCAGUpdateApiImpl(){};
    ~ProvidingAcknowledgementOfCAGUpdateApiImpl() {}

    static void c_ag_ack(const std::string &supi, const AcknowledgeInfo &acknowledgeInfo, response &responseIn)
    {
        // not implement
    }
