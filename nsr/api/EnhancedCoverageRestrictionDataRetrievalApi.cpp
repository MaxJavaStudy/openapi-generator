 ...
 */
/*
 * EnhancedCoverageRestrictionDataRetrievalApi.c
 *
 *
 */
...
void EnhancedCoverageRestrictionDataRetrievalApi::get_ecr_data_handler(
  ...
  try {
    ...
    /// to &quot;&quot;)</param>
    EnhancedCoverageRestrictionDataRetrievalApiImpl::get_ecr_data(
        supi, supportedFeatures, ifNoneMatch, ifModifiedSince, requestIn,
        responseIn);
