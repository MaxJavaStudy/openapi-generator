...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_UEContextInSMFDataRetrievalApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_UEContextInSMFDataRetrievalApi_H_
...
public:
    ...
    explicit UEContextInSMFDataRetrievalApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<std::shared_ptr<UeContextInSmfData>> getUeCtxInSmfData(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_UEContextInSMFDataRetrievalApi_H_ */
