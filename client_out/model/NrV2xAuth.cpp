...
web::json::value NrV2xAuth::toJson() const
{
...
bool NrV2xAuth::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void NrV2xAuth::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool NrV2xAuth::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::shared_ptr<UeAuth> NrV2xAuth::getVehicleUeAuth() const
{
    return m_VehicleUeAuth;
}

void NrV2xAuth::setVehicleUeAuth(const std::shared_ptr<UeAuth>& value)
{
...
std::shared_ptr<UeAuth> NrV2xAuth::getPedestrianUeAuth() const
{
    return m_PedestrianUeAuth;
}

void NrV2xAuth::setPedestrianUeAuth(const std::shared_ptr<UeAuth>& value)
{
