...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_LCSPrivacyDataRetrievalApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_LCSPrivacyDataRetrievalApi_H_
...
public:
    ...
    explicit LCSPrivacyDataRetrievalApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<std::shared_ptr<LcsPrivacyData>> getLcsPrivacyData(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_LCSPrivacyDataRetrievalApi_H_ */
