...
///
/// </summary>
class LteV2xAuth : public jsonParser::jsonParser<LteV2xAuth> {
public:
  explicit LteV2xAuth() {
    // constructor
  ...
  friend std::ostream &operator<<(std::ostream &o, const LteV2xAuth &obj) {
  ...
  /////////////////////////////////////////////
  /// LteV2xAuth members vars : VehicleUeAuth PedestrianUeAuth
