...
private:
    ...
    static void get_trace_config_data_handler(request &requestIn,  response responseIn)
    {
    ...
    /// <param name="ifModifiedSince">Validator for conditional requests, as described in RFC 7232, 3.3 (optional, default to &quot;&quot;)</param>
      TraceConfigurationDataRetrievalApiImpl::get_trace_config_data(supi, supportedFeatures, plmnId, ifNoneMatch, ifModifiedSince, response);
