...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_SMSManagementSubscriptionDataRetrievalApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_SMSManagementSubscriptionDataRetrievalApi_H_
...
public:
    ...
    explicit SMSManagementSubscriptionDataRetrievalApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<std::shared_ptr<SmsManagementSubscriptionData>> getSmsMngtData(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_SMSManagementSubscriptionDataRetrievalApi_H_ */
