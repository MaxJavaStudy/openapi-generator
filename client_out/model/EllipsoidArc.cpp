...
web::json::value EllipsoidArc::toJson() const
{
...
bool EllipsoidArc::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void EllipsoidArc::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EllipsoidArc::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::shared_ptr<GeographicalCoordinates> EllipsoidArc::getPoint() const
{
    return m_Point;
}

void EllipsoidArc::setPoint(const std::shared_ptr<GeographicalCoordinates>& value)
{
    m_Point = value;
    m_PointIsSet = true;
}

bool EllipsoidArc::pointIsSet() const
{
    return m_PointIsSet;
}

void EllipsoidArc::unsetPoint()
{
    m_PointIsSet = false;
}
...
void EllipsoidArc::setInnerRadius(int32_t value)
{
    m_InnerRadius = value;
    m_InnerRadiusIsSet = true;
}

bool EllipsoidArc::innerRadiusIsSet() const
{
    return m_InnerRadiusIsSet;
}

void EllipsoidArc::unsetInnerRadius()
{
    m_InnerRadiusIsSet = false;
}
...
void EllipsoidArc::setUncertaintyRadius(float value)
{
    m_UncertaintyRadius = value;
    m_UncertaintyRadiusIsSet = true;
}

bool EllipsoidArc::uncertaintyRadiusIsSet() const
{
    return m_UncertaintyRadiusIsSet;
}

void EllipsoidArc::unsetUncertaintyRadius()
{
    m_UncertaintyRadiusIsSet = false;
}
...
void EllipsoidArc::setOffsetAngle(int32_t value)
{
    m_OffsetAngle = value;
    m_OffsetAngleIsSet = true;
}

bool EllipsoidArc::offsetAngleIsSet() const
{
    return m_OffsetAngleIsSet;
}

void EllipsoidArc::unsetOffsetAngle()
{
    m_OffsetAngleIsSet = false;
}
...
void EllipsoidArc::setIncludedAngle(int32_t value)
{
    m_IncludedAngle = value;
    m_IncludedAngleIsSet = true;
}

bool EllipsoidArc::includedAngleIsSet() const
{
    return m_IncludedAngleIsSet;
}

void EllipsoidArc::unsetIncludedAngle()
{
    m_IncludedAngleIsSet = false;
}
...
void EllipsoidArc::setConfidence(int32_t value)
{
    m_Confidence = value;
    m_ConfidenceIsSet = true;
}

bool EllipsoidArc::confidenceIsSet() const
{
    return m_ConfidenceIsSet;
}

void EllipsoidArc::unsetConfidence()
{
    m_ConfidenceIsSet = false;
}
}
