...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_LCSBroadcastAssistanceDataTypesRetrievalApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_LCSBroadcastAssistanceDataTypesRetrievalApi_H_
...
public:
    ...
    explicit LCSBroadcastAssistanceDataTypesRetrievalApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<std::shared_ptr<LcsBroadcastAssistanceTypesData>> getLcsBcaData(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_LCSBroadcastAssistanceDataTypesRetrievalApi_H_ */
