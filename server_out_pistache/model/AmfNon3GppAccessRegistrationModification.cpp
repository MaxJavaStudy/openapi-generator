...
void AmfNon3GppAccessRegistrationModification::setImsVoPs(ImsVoPs const& value)
{
    m_ImsVoPs = value;
    m_ImsVoPsIsSet = true;
}
...
std::vector<BackupAmfInfo>& AmfNon3GppAccessRegistrationModification::getBackupAmfInfo()
{
    return m_BackupAmfInfo;
}
void AmfNon3GppAccessRegistrationModification::setBackupAmfInfo(std::vector<BackupAmfInfo> const& value)
{
