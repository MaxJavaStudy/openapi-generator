...
class ScheduledCommunicationType
    : public jsonParser::jsonParser<ScheduledCommunicationType> {
public:
  explicit ScheduledCommunicationType(){
      // constructor
  ...
  std::pair<jsonRet, std::string> decode(const std::string &jsonBuffer,
    ...
    m_ScheduledCommunicationType = jsonBuffer;
    return ret;
  }
  ...
  friend std::ostream &operator<<(std::ostream &o,
                                  const ScheduledCommunicationType &obj) {

    return o;
  }

public:
  std::string m_ScheduledCommunicationType;
};
