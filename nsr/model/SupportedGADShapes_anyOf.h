...
class SupportedGADShapes_anyOf
    : public jsonParser::jsonParser<SupportedGADShapes_anyOf> {
public:
  explicit SupportedGADShapes_anyOf(){
      // constructor
  ...
  std::pair<jsonRet, std::string> decode(const std::string &jsonBuffer,
    ...
    m_SupportedGADShapes_anyOf = jsonBuffer;
    return ret;
  }
  ...
  friend std::ostream &operator<<(std::ostream &o,
                                  const SupportedGADShapes_anyOf &obj) {

    return o;
  }

public:
  std::string m_SupportedGADShapes_anyOf;
};
