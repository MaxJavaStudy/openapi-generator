...
std::vector<BackupAmfInfo>& Amf3GppAccessRegistrationModification::getBackupAmfInfo()
{
    return m_BackupAmfInfo;
}
void Amf3GppAccessRegistrationModification::setBackupAmfInfo(std::vector<BackupAmfInfo> const& value)
{
...
EpsInterworkingInfo Amf3GppAccessRegistrationModification::getEpsInterworkingInfo() const
{
    return m_EpsInterworkingInfo;
}
void Amf3GppAccessRegistrationModification::setEpsInterworkingInfo(EpsInterworkingInfo const& value)
{
...
void Amf3GppAccessRegistrationModification::setNoEeSubscriptionInd(bool const value)
{
