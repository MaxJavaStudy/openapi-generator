...
public:
    explicit UnrelatedClass(){
        // constructor
            ...
            m_ExternalUnrelatedClassFlag = (staticjson::Flags::Optional);

            m_ServiceTypeUnrelatedClassesFlag = (staticjson::Flags::Optional);
    };
    ...
    void staticjson_init(staticjson::ObjectHandler *h)
    {
        ...
        // static json settings members vars : DefaultUnrelatedClass ExternalUnrelatedClass ServiceTypeUnrelatedClasses 
        h->add_property("defaultUnrelatedClass", &this->m_DefaultUnrelatedClass, m_DefaultUnrelatedClassFlag);
        h->add_property("externalUnrelatedClass", &this->m_ExternalUnrelatedClass, m_ExternalUnrelatedClassFlag);
        h->add_property("serviceTypeUnrelatedClasses", &this->m_ServiceTypeUnrelatedClasses, m_ServiceTypeUnrelatedClassesFlag);
    ...
    friend std::ostream& operator<<(std::ostream& o, const UnrelatedClass& obj)
    {
        ...
        o << "ExternalUnrelatedClass : " << obj.m_ExternalUnrelatedClass << std::endl;
        o<< convert2string(std::string("ServiceTypeUnrelatedClasses"), obj.m_ServiceTypeUnrelatedClasses) <<std::endl;
    ...
    /////////////////////////////////////////////
    /// UnrelatedClass members vars : DefaultUnrelatedClass ExternalUnrelatedClass ServiceTypeUnrelatedClasses 
