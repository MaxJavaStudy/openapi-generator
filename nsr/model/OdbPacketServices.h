...
///
/// </summary>
class OdbPacketServices : public jsonParser::jsonParser<OdbPacketServices> {
public:
  explicit OdbPacketServices(){
      // constructor
  ...
  std::pair<jsonRet, std::string> decode(const std::string &jsonBuffer,
    ...
    m_OdbPacketServices = jsonBuffer;
    return ret;
  }
  ...
  friend std::ostream &operator<<(std::ostream &o,
                                  const OdbPacketServices &obj) {

    return o;
  }

public:
  std::string m_OdbPacketServices;
};
