...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_GPSIToSUPITranslationApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_GPSIToSUPITranslationApi_H_
...
public:
    ...
    explicit GPSIToSUPITranslationApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    /// <param name="appPortId">Application port identifier (optional, default to new AppPortId())</param>
    ...
    pplx::task<std::shared_ptr<IdTranslationResult>> getSupiOrGpsi(
        utility::string_t ueId,
        boost::optional<utility::string_t> supportedFeatures,
        boost::optional<std::shared_ptr<AppPortId>> appPortId,
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_GPSIToSUPITranslationApi_H_ */
