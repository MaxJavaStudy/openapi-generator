...
///
/// </summary>
class Inline_object : public jsonParser::jsonParser<Inline_object> {
public:
  explicit Inline_object() {
    // constructor
  ...
  friend std::ostream &operator<<(std::ostream &o, const Inline_object &obj) {
  ...
  /////////////////////////////////////////////
  /// Inline_object members vars : JsonData BinaryDataUeRadioCapability5GS
  /// BinaryDataUeRadioCapabilityEPS

  DicEntryCreateData getJsonData() const { return m_JsonData; }
  void setJsonData(DicEntryCreateData const &value) { m_JsonData = value; }
