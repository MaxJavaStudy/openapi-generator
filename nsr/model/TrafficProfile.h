...
///
/// </summary>
class TrafficProfile : public jsonParser::jsonParser<TrafficProfile> {
public:
  ...
  friend std::ostream &operator<<(std::ostream &o, const TrafficProfile &obj) {
