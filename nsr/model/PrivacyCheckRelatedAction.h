...
class PrivacyCheckRelatedAction
    : public jsonParser::jsonParser<PrivacyCheckRelatedAction> {
public:
  explicit PrivacyCheckRelatedAction(){
      // constructor
  ...
  std::pair<jsonRet, std::string> decode(const std::string &jsonBuffer,
    ...
    m_PrivacyCheckRelatedAction = jsonBuffer;
    return ret;
  }
  ...
  friend std::ostream &operator<<(std::ostream &o,
                                  const PrivacyCheckRelatedAction &obj) {

    return o;
  }

public:
  std::string m_PrivacyCheckRelatedAction;
};
