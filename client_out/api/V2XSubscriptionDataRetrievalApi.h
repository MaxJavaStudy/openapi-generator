...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_V2XSubscriptionDataRetrievalApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_V2XSubscriptionDataRetrievalApi_H_
...
public:
    ...
    explicit V2XSubscriptionDataRetrievalApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<std::shared_ptr<V2xSubscriptionData>> getV2xData(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_V2XSubscriptionDataRetrievalApi_H_ */
