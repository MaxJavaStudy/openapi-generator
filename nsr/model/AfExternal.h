...
///
/// </summary>
class AfExternal : public jsonParser::jsonParser<AfExternal> {
public:
  explicit AfExternal() {
    // constructor
    m_AfId = "";

    m_AfIdFlag = (staticjson::Flags::Optional | staticjson::Flags::IgnoreWrite);
  ...
  void staticjson_init(staticjson::ObjectHandler *h) {
    ...
    // static json settings members vars : AfId AllowedGeographicArea
    // PrivacyCheckRelatedAction ValidTimePeriod
    h->add_optional_property("afId", &this->m_AfId, m_AfIdFlag, m_AfIdOutFlag);
  ...
  friend std::ostream &operator<<(std::ostream &o, const AfExternal &obj) {

    o << "AfId, optional flag is : " << *m_AfIdOutFlag
      << ", content is : " << obj.m_AfId << std::endl;
  ...
  /////////////////////////////////////////////
  /// AfExternal members vars : AfId AllowedGeographicArea
  /// PrivacyCheckRelatedAction ValidTimePeriod
