...
public:
  explicit Lpi() {
    ...
    m_LocationPrivacyIndOutFlag.reset(new unsigned);
    *m_LocationPrivacyIndOutFlag.get() = 0;
  ...
  void staticjson_init(staticjson::ObjectHandler *h) {
    ...
    h->add_property("locationPrivacyInd", &this->m_LocationPrivacyInd,
                    m_LocationPrivacyIndFlag);
...
public:
  ...
  shared_ptr<unsigned> m_LocationPrivacyIndOutFlag;
