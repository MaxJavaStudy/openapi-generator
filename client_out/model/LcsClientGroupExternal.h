...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_LcsClientGroupExternal_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_LcsClientGroupExternal_H_
...
public:
    ...
    /// 
    /// </summary>
    utility::string_t getLcsClientGroupId() const;
    bool lcsClientGroupIdIsSet() const;
    void unsetLcsClientGroupId();

    void setLcsClientGroupId(const utility::string_t& value);
...
protected:
    utility::string_t m_LcsClientGroupId;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_LcsClientGroupExternal_H_ */
