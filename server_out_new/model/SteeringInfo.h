...
public:
    explicit SteeringInfo(){
        // constructor
            ...
            m_AccessTechListFlag = (staticjson::Flags::Optional);
    };
    ...
    void staticjson_init(staticjson::ObjectHandler *h)
    {
        ...
        h->add_property("accessTechList", &this->m_AccessTechList, m_AccessTechListFlag);
    ...
    friend std::ostream& operator<<(std::ostream& o, const SteeringInfo& obj)
    {
        ...
        o<< convert2string(std::string("AccessTechList"), obj.m_AccessTechList) <<std::endl;
