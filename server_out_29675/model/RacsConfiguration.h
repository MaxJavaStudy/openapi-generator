...
///
/// </summary>
class RacsConfiguration : public jsonParser::jsonParser<RacsConfiguration> {
public:
  explicit RacsConfiguration() {
    // constructor
    m_RacsId = "";

    m_RacsIdFlag = staticjson::Flags::Default;
    m_RacsParamEps = "";
    ...
    m_ImeiTacsFlag = staticjson::Flags::Default;
  };
  virtual ~RacsConfiguration(){};

  void staticjson_init(staticjson::ObjectHandler *h) {

    // static json settings members vars : RacsId RacsParamEps RacsParam5Gs
    // ImeiTacs
    h->add_property("racsId", &this->m_RacsId, m_RacsIdFlag);
  ...
  friend std::ostream &operator<<(std::ostream &o,
                                  const RacsConfiguration &obj) {

    o << "RacsId : " << obj.m_RacsId << std::endl;
  ...
  /////////////////////////////////////////////
  /// RacsConfiguration members vars : RacsId RacsParamEps RacsParam5Gs ImeiTacs

  std::string getRacsId() const { return m_RacsId; }
  void setRacsId(std::string const &value) { m_RacsId = value; }
