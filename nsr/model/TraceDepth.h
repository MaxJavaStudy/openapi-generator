...
///
/// </summary>
class TraceDepth : public jsonParser::jsonParser<TraceDepth> {
public:
  explicit TraceDepth(){
      // constructor
  ...
  friend std::ostream &operator<<(std::ostream &o, const TraceDepth &obj) {

    return o;
  }

public:
  std::string m_TraceDepth;
};
