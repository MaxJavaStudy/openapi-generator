...
class PointUncertaintyEllipse
    : public jsonParser::jsonParser<PointUncertaintyEllipse> {
public:
  ...
  void staticjson_init(staticjson::ObjectHandler *h) {
    ...
    // static json settings members vars : Shape Point UncertaintyEllipse
    // Confidence
  ...
  friend std::ostream &operator<<(std::ostream &o,
                                  const PointUncertaintyEllipse &obj) {
  ...
  /////////////////////////////////////////////
  /// PointUncertaintyEllipse members vars : Shape Point UncertaintyEllipse
  /// Confidence
