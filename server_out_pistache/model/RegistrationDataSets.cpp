...
void RegistrationDataSets::setAmfNon3Gpp(AmfNon3GppAccessRegistration const& value)
{
    m_AmfNon3Gpp = value;
...
void RegistrationDataSets::setSmfRegistration(SmfRegistrationInfo const& value)
{
