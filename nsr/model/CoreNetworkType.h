...
///
/// </summary>
class CoreNetworkType : public jsonParser::jsonParser<CoreNetworkType> {
public:
  explicit CoreNetworkType(){
      // constructor
  ...
  friend std::ostream &operator<<(std::ostream &o, const CoreNetworkType &obj) {

    return o;
  }

public:
  std::string m_CoreNetworkType;
};
