...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_UEContextInSMSFDataRetrievalApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_UEContextInSMSFDataRetrievalApi_H_
...
public:
    ...
    explicit UEContextInSMSFDataRetrievalApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<std::shared_ptr<UeContextInSmsfData>> getUeCtxInSmsfData(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_UEContextInSMSFDataRetrievalApi_H_ */
